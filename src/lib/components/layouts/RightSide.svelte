<script>
let {children , onlyRightSide } = $props();
...
<div class="container-fluid">  
    <div class="row">
        ...
        <div class="col-12 g-0 content">
            <div class="d-flex flex-row h-100">
                <div class="flex-fill h-100 theme-pallate-content p-2">
                   {@render children()}
                </div>
                <div class="ms-auto h-100 theme-pallate-side p-4" style:min-width={"250px"}>
                    {@render onlyRightSide()}
                </div>
            </div>
        </div>
    </div>
